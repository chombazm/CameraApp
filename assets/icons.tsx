...
export const TabHomeIcon = (props: Props) => (
  <Svg width={24} height={24} fill="none" {...props}>
    <Path
      ...
      stroke={props.focused ? 'none' : props.color}
      strokeWidth={1.3}
    />
    <Path
      d="M12 18.75c-.41 0-.75-.34-.75-.75v-3c0-.41.34-.75.75-.75s.75.34.75.75v3c0 .41-.34.75-.75.75Z"
      fill={props.focused ? '#fff' : props.color}
    />
  </Svg>
);
export const TabExploreIcon = (props: Props) => (
  <Svg
    width={17}
    height={24}
    fill={props.focused ? props.color : 'none'}
    {...props}>
    <Path
      d="m15 4.443.113-.64h-.004L15.1 3.8l-.027-.004a6.889 6.889 0 0 0-.43-.05 8.852 8.852 0 0 0-1.145-.021c-.922.042-2.154.243-3.29.907-.533.31-1.021.65-1.449 1-.404-.73-.978-1.49-1.677-2.196-1.01-1.02-2.288-1.536-3.278-1.798a9.415 9.415 0 0 0-1.633-.28 4.833 4.833 0 0 0-.107-.007l-.03-.001H2.018L2 2m13 2.443.611.221v.002l-.001.003-.003.008-.01.026-.036.09a9.07 9.07 0 0 1-.69 1.322c-.496.784-1.283 1.76-2.42 2.424-1.069.624-2.172 1.048-3.099 1.195v2.332h4.118a1.36 1.36 0 0 1 1.357 1.364v1.428c0 .713-.547 1.308-1.255 1.36l-.736 4.965-.643-.095.643.095a1.713 1.713 0 0 1-1.69 1.467H5.2c-.852 0-1.567-.63-1.69-1.467l.642-.095-.643.095-.736-4.964a1.361 1.361 0 0 1-1.255-1.36V13.43c0-.747.6-1.364 1.357-1.364h4.118v-2.66a5.614 5.614 0 0 1-1.433-.595c-.712-.406-1.454-.98-2.15-1.683-1.008-1.02-1.516-2.31-1.775-3.309a9.685 9.685 0 0 1-.276-1.647 5 5 0 0 1-.007-.108l-.001-.031V2.019L2 2m13 2.443.114-.64.76.135-.263.726-.611-.22ZM2 2l-.65.018-.019-.687.688.02L2 2Zm-.02.65h.001Zm.67-.67Z"
      stroke={props.focused ? 'none' : props.color}
      strokeWidth={1.3}
    />
  </Svg>
);
export const TabArticlesIcon = (props: Props) => (
  <Svg
    width={24}
    height={24}
    fill={props.focused ? props.color : 'none'}
    ...
    <Path
      ...
      stroke={props.focused ? '#fff' : props.color}
      strokeWidth={1.5}
      strokeLinecap="round"
      strokeLinejoin="round"
    />
...
export const TabSavedIcon = (props: Props) => (
  <Svg
    width={18}
    height={22}
    fill={props.focused ? props.color : 'none'}
    {...props}>
    <Path
      d="m10.36 19.092-.003-.002c-.412-.246-.903-.348-1.357-.348-.454 0-.945.102-1.357.348l-.003.002-2.373 1.434h-.002c-1.428.855-2.544.864-3.248.48C1.321 20.626.75 19.71.75 18.083V5.366c.009-1.668.432-2.785 1.142-3.49C2.602 1.168 3.725.75 5.4.75h7.2c1.666 0 2.786.415 3.497 1.114.71.699 1.136 1.803 1.153 3.45v12.77c0 1.625-.57 2.542-1.267 2.922-.704.384-1.82.375-3.248-.48h-.002l-2.373-1.434Z"
      stroke={props.focused ? '#fff' : props.color}
      strokeWidth={1.5}
    />
  </Svg>
);
export const TabProfileIcon = (props: Props) => (
  <Svg
    width={24}
    height={24}
    fill={props.focused ? props.color : 'none'}
    {...props}>
    <Path
      d="M8 6.75c0-2.206 1.794-4 4-4 2.205 0 4 1.793 4 3.999a3.988 3.988 0 0 1-3.844 3.991h-.008c-.1-.01-.2-.01-.291-.002C9.66 10.639 8 8.896 8 6.75ZM7.338 19.967l-.002-.001c-1.108-.739-1.626-1.668-1.626-2.586 0-.918.518-1.857 1.636-2.606 1.257-.831 2.944-1.269 4.666-1.269 1.724 0 3.406.438 4.652 1.269 1.103.735 1.617 1.664 1.626 2.589-.001.927-.52 1.856-1.629 2.605-1.251.84-2.937 1.282-4.661 1.282-1.724 0-3.41-.442-4.662-1.283Z"
      stroke={props.color}
      strokeWidth={1.5}
    />
  </Svg>
